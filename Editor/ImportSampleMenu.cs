...
{
    internal static class ImportSampleMenu_UIAtlasImage
    {
        private const string k_DisplayName = "UI Atlas Image";
        private const string k_JsonGuid = "b9ea23bb827354bfaacf881970614a86";
